...
function __autoload($class_name)
{
    ...
    if (file_exists($mod_file_path)){ require_once($mod_file_path); } elseif (file_exists($file_path)){ require_once($file_path); } else if(file_exists($mod_file_path_legacy)){ require_once($mod_file_path_legacy); } else if(file_exists($file_path_legacy)){ require_once($file_path_legacy); } else if(file_exists($mod_file_path_legacy2)){ require_once($mod_file_path_legacy2); } else if(file_exists($file_path_legacy2)) { require_once($file_path_legacy2); }
